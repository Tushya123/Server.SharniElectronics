...
exports.downloadPdf = async (req, res, next) => {
  try {
    ...
    const logoUrl = `https://server.sharnielectronics.com/uploads/header.png`;

    // Fetch and save the product image temporarily
    const productImageUrl = ImageUrl!==""?`https://server.sharnielectronics.com/${ImageUrl}`:`https://server.sharnielectronics.com/uploads/Image_not_available.jpg`;

...
exports.createProjectDetail = async (req, res) => {
  try {
    ...
    let { ServiceDetail, Description, IsActive, ProductDetailDescription,CkDesc } = req.body;
...
//     const logoUrl = `${__basedir}/uploads/header.png`;

//     // Fetch and save the product image temporarily
//     // const productImageUrl = ImageUrl!==""?`https://server-sharnielectronics.onrender.com/${ImageUrl}`:`https://server-sharnielectronics.onrender.com/uploads/Image_not_available.jpg`;
//     const productImageUrl = ImageUrl!==""?`${__basedir}/${ImageUrl}`:`${__basedir}/uploads/Image_not_available.jpg`;
